...
public class CompositeArrayAccess extends Expression {
	 ...
	 * but legal, expression.
	 */
	private Expression indexExpressionOne = null;
	private Expression indexExpressionTwo = null;
		...
		if (this.arrayExpression == null) {
			...
			synchronized (this) {
				if (this.arrayExpression == null) {
					...
					postLazyInit(this.arrayExpression, COMPOSITE_ARRAY_PROPERTY);
				}
			}
		}
	...
	public Expression getIndexOne() {
		if (this.indexExpressionOne == null) {
			...
			synchronized (this) {
				if (this.indexExpressionOne == null) {
					preLazyInit();
					this.indexExpressionOne = new SimpleName(this.ast);
					postLazyInit(this.indexExpressionOne, INDEX_ONE_PROPERTY);
				}
			}
		}
	...
	public Expression getIndexTwo() {
		if (this.indexExpressionTwo == null) {
			...
			synchronized (this) {
				if (this.indexExpressionTwo == null) {
					preLazyInit();
					this.indexExpressionTwo = new SimpleName(this.ast);
					postLazyInit(this.indexExpressionTwo, INDEX_TWO_PROPERTY);
				}
			}
		}
