...
public class CASEStatement extends Statement {
    ...
    /**
     * Returns the constant intValue or ordinal for enum constants. If constant
     * is NotAConstant, then answers Float.MIN_VALUE
     *
     * @see
     * org.eclipse.jdt.internal.compiler.ast.Statement#resolveCase(org.eclipse.jdt.internal.compiler.lookup.BlockScope,
    ...
    public void generateOperatorOverloadCodeForCASE(MethodBinding mb2, BlockScope currentScope, CodeStream codeStream, boolean valueRequired) {
        ...
        if (mb2.hasSubstitutedParameters() || mb2.hasSubstitutedReturnType()) {
            ...
            if (!mb2.returnType.isBaseType()) {
                codeStream.checkcast(mb2.returnType);
            }
        }
    }
